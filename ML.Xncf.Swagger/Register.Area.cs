...
namespace ML.Xncf.Swagger
{
    public partial class Register : IAreaRegister //注册 XNCF 页面接口（按需选用）
    {
        ...
        public IMvcBuilder AuthorizeConfig(IMvcBuilder builder, IHostEnvironment env)
        {
            ...
            SenparcTrace.SendCustomLog("Swagger 启动", "完成 Area:ML.Xncf.Swagger 注册");
        ...
        public string LibraryPath => Path.GetFullPath(Path.Combine(SiteConfig.WebRootPath, "..", "..", "ML.Xncf.Swagger"));
        #endregion
    }
}
