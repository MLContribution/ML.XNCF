...
namespace ML.Xncf.Docs.Models.DatabaseModel
{
    ...
    public class DocsSenparcEntities_MySql : DocsSenparcEntities
    {
        public DocsSenparcEntities_MySql(DbContextOptions<DocsSenparcEntities_MySql> dbContextOptions) : base(dbContextOptions)
        {
        }
    }
    ...
    /// <para>2、运行：PM> add-migration [更新名称] -c DocsSenparcEntities_MySql -o Migrations/Migrations.MySql </para>
    /// </summary>
    public class SenparcDbContextFactory_MySql : SenparcDesignTimeDbContextFactoryBase<DocsSenparcEntities_MySql, Register>
    {
