...
namespace ML.Xncf.Docs
{
    ...
    public partial class Register : XncfRegisterBase, IXncfRegister
    {
        ...
        public override string Version => "2.1.7.22";//必须填写版本号
        ...
        {
            //指定需要删除的数据实体
            ClearDocsAppService clearDocsAppService = serviceProvider.GetService<ClearDocsAppService>();
            var docsRunRequest = new Docs_RunRequest();
            await clearDocsAppService.Run(docsRunRequest);
