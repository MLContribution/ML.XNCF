...
{
    public partial class _20200902v1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "ML_Docs_Article",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ML_Docs_Article", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "ML_Docs_Catalog",
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ML_Docs_Catalog", x => x.Id);
                });
        }
